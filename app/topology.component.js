...
var TopologyComponent = (function () {
    ...
    ;
    TopologyComponent.prototype.addNode = function () {
        try {
    ...
    TopologyComponent.prototype.updateNode = function () {
        try {
    ...
    TopologyComponent.prototype.removeNode = function () {
        try {
            if (this.nodes.get(document.getElementById('node-id').value) !== null) {
                this.nodes.remove({
                    id: document.getElementById('node-id').value,
    ...
    TopologyComponent.prototype.addEdge = function () {
        try {
            this.edges.add({
    ...
    TopologyComponent.prototype.updateEdge = function () {
        try {
            this.edges.update({
                id: document.getElementById('edge-id').value,
                from: document.getElementById('edge-from').value,
    ...
    TopologyComponent.prototype.removeEdge = function () {
        try {
